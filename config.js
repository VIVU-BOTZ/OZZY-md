...
const DB_URL =  process.env.DATABASE_URL || 'mongodb+srv://KUSHAN:5000@cluster0.zji09ho.mongodb.net/';
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'jsl~f7510wj8S1b6e69159044dc6aa5818e9cd43', //your ssid to run bot
    HEROKU: {
